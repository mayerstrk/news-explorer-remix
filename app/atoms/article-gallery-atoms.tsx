...
export function ArticleCard({
  ...
  return (
    <li
      className={clsx(
        fetcherState && fetcherState !== 'idle' ? 'hidden' : '',
        'relative mx-auto flex h-[440px] w-full flex-col rounded-lg bg-white shadow-sm shadow-gray-100 md:h-[420px] md:w-[224px] xl:h-[576px] xl:w-[400px]',
      )}
    >
      {children}
      {imageUrl && !noImage ? (
