...
export default function Home() {
  ...
  return (
    <>
      <nav className='flex h-16 w-full items-stretch justify-between border-b-2 border-gray-400 bg-indigo-400 px-4 md:h-20 xl:h-24'>
        <div
        ...
        <div className='flex h-full items-center md:hidden'>
          <button
            type='button'
            className={`size- bg-[url('/images/menu.svg')] bg-cover bg-center `}
      ...
      <header
        className={clsx(
          ' flex w-full flex-col items-center', // display
          ...
          <div className='md flex max-w-[600px] flex-col gap-[16px] xl:gap-[35px] xl:self-start xl:pt-[51px]'>
            ...
            >
              <p className='text-[18px] leading-[24px]'>
                Hey 👋, I&apos;m Mayer, a full-stack developer 🚀. I lead a team
                of mobile and web developers in the Israeli Defence Forces.
              </p>
              <p className='text-[18px] leading-[24px]'>
              ...
              <p className='text-[18px] leading-[24px]'>
                ...
                make sure we implement the most appropriate technologies to our
                solutions. Moreover, I am actively involved in educating new
                recruits about our technology stack, ensuring they are
